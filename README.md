...
> ⚠️ *Note:*  
> I am currently working on getting the ADM0 results to match the ADM0 totals shown on the [Protected Planet website](https://www.protectedplanet.net/) — particularly for India, Bangladesh, and Pakistan.  
> I believe the mismatch is related to **disputed or independent territories** not being fully accounted for in the shapefile boundaries I'm using, or them not being returned when you use the search api with the country parameter.  The number of protected areas does match what is on the website.
