...
⚠️ *Note:* ADM0 totals may not match the [Protected Planet](https://www.protectedplanet.net/) website due to missing or disputed territories, but ADM1 and ADM2 calculations are unaffected and remain reliable.
